...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test GMBLSTM with pretrained models")

    parser.add_argument(
        "--dataset", type=str,
        default='Metz', help='Dataset Name (davis,kiba,Metz)'
    )

    parser.add_argument(
        "--batch_size", type=int,
        default=256, help='Test Batch size. For davis is 128'
    )
